...
function classify(x){const vals=[x.oi5,x.oi15,x.oi1h,x.oi4h],persistent=vals.filter(Number.isFinite).length>=2&&vals.filter(Number.isFinite).every(v=>v>0),acceleration=Number.isFinite(x.oi1)&&Number.isFinite(x.oi5)?x.oi1*5>x.oi5*1.2:Number.isFinite(x.oi15)&&Number.isFinite(x.oi1h)&&x.oi15>0&&x.oi1h>0&&x.oi15*4>x.oi1h*1.2;const surge=(x.oi1??-99)>=1.5||(x.oi5??-99)>=3||(x.oi15??-99)>=5||(x.oi1h??-99)>=10||(x.oi4h??-99)>=20,early=acceleration&&((x.oi1??-99)>=0.5||(x.oi5??-99)>=1.5||(x.oi15??-99)>=3);return{hit:surge||early,level:surge?"SURGE":early?"ACCELERATION":null,persistent,acceleration}}
